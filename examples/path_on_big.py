...
map_ = import_map(model, import_json("\\wsl.localhost\\Ubuntu-20.04\\home\\sasha\robot_sorting\\Charging-management-in-a-robotic-warehouse\\data\\map1-simple.json"), mail_factory)[0]
model.set_map(map_)
